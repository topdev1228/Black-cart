...
/**
 * App\Domain\Orders\Models\TbybNetSale
 *
 * @property string $id
...
class TbybNetSale extends Model
{
    ...
    protected $table = 'orders_tbyb_net_sales';
    ...
    protected function casts(): array
    {
        return [
            ...
            'tbyb_gross_sales' => MoneyCast::class . ':currency',
            'tbyb_discounts' => MoneyCast::class . ':currency',
            'tbyb_refunded_gross_sales' => MoneyCast::class . ':currency',
            'tbyb_refunded_discounts' => MoneyCast::class . ':currency',
            'tbyb_net_sales' => MoneyCast::class . ':currency',
            'date_start' => 'datetime',
            'date_end' => 'datetime',
