...
/**
 * @property mixed|null $arn
 * @property string|null $format
 * @property array<string>|null $includeFields
 * @property array<string>|null $metafieldNamespaces
 */
class EventBridgeWebhookSubscriptionInput extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param mixed|null $arn
     * @param string|null $format
     * @param array<string>|null $includeFields
     * @param array<string>|null $metafieldNamespaces
     */
    public static function make(
        $arn = 'Special default value that allows Sailor to differentiate between explicitly passing null and not passing a value at all.',
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            'arn' => new \Spawnia\Sailor\Convert\NullConverter(new \Spawnia\Sailor\Convert\ScalarConverter),
