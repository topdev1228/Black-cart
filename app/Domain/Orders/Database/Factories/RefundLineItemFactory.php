...
class RefundLineItemFactory extends Factory
{
    ...
    public function tbyb(bool $isTbyb): static
    {
        return $this->state([
            'is_tbyb' => $isTbyb,
        ]);
    ...
    public function withDiscount(int $discountShopAmount = 2000, $discountCustomerAmount = 2000): static
    {
        return $this->state([
            'discounts_shop_amount' => $discountShopAmount,
            'discounts_customer_amount' => $discountCustomerAmount,
        ]);
    }

    public function upfront(bool $isUpfront): static
    {
        return $this->tbyb(!$isUpfront);
    }
}
