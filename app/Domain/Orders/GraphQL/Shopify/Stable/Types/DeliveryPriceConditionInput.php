...
/**
 * @property \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MoneyInput|null $criteria
 * @property string|null $operator
 */
class DeliveryPriceConditionInput extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MoneyInput|null $criteria
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            'criteria' => new \Spawnia\Sailor\Convert\NullConverter(new \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MoneyInput),
