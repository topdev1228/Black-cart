...
class TbybNetSalesServiceTest extends TestCase
{
    protected Store $currentStore;
    protected TbybNetSalesService $tbybNetSalesService;
    ...
    protected function setUp(): void
    {
        ...
        $this->tbybNetSalesService = resolve(TbybNetSalesService::class);
    }
    ...
    public function testItDoesNotCreatesTbybNetSaleOnExisting(): void
    {
        ...
        $actualTbybNetSale = $this->tbybNetSalesService->create($tbybNetSaleValue);
