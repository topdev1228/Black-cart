 ...
 * @property \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MetafieldAccessUpdateInput|null $access
 ...
 */
class MetafieldDefinitionUpdateInput extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param string $key
     * @param string $ownerType
     * @param \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MetafieldAccessUpdateInput|null $access
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            ...
            'access' => new \Spawnia\Sailor\Convert\NullConverter(new \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MetafieldAccessUpdateInput),
