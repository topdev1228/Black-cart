 ...
 * @property array<\App\Domain\Orders\GraphQL\Shopify\Stable\Types\MetafieldAccessGrantInput>|null $grants
 * @property string|null $storefront
 */
class MetafieldAccessInput extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param string $admin
     * @param array<\App\Domain\Orders\GraphQL\Shopify\Stable\Types\MetafieldAccessGrantInput>|null $grants
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            ...
            'grants' => new \Spawnia\Sailor\Convert\NullConverter(new \Spawnia\Sailor\Convert\ListConverter(new \Spawnia\Sailor\Convert\NonNullConverter(new \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MetafieldAccessGrantInput))),
