 ...
 * @property int|string $productVariantId
 ...
 */
class SubscriptionLineInput extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param mixed $currentPrice
     * @param int|string $productVariantId
     * @param int $quantity
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            'currentPrice' => new \Spawnia\Sailor\Convert\NonNullConverter(new \Spawnia\Sailor\Convert\ScalarConverter),
            'productVariantId' => new \Spawnia\Sailor\Convert\NonNullConverter(new \Spawnia\Sailor\Convert\IDConverter),
