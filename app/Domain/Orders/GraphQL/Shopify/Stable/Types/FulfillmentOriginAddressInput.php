 ...
 */
class FulfillmentOriginAddressInput extends \Spawnia\Sailor\ObjectLike
{
    /**
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            'countryCode' => new \Spawnia\Sailor\Convert\NonNullConverter(new \Spawnia\Sailor\Convert\StringConverter),
