...
/**
 * @property \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MoneyInput|null $price
 * @property string|null $title
 */
class OrderEditUpdateShippingLineInput extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MoneyInput|null $price
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            'price' => new \Spawnia\Sailor\Convert\NullConverter(new \App\Domain\Orders\GraphQL\Shopify\Stable\Types\MoneyInput),
