...
class ReAuthSuccessEmailTest extends TestCase
{
    ...
    public function testReAuthSuccessDisplaysCorrectInformation(): void
    {
        ...
        $mailable = new ReAuthSuccess($orderValue, Money::of(100, 'USD'));
